...
class AppController(QObject):
    ...
    def _create_preview_window(self):
        ...
        self.preview_start_button = QPushButton("开始", window)
        self.preview_start_button.setObjectName("primaryActionButton")
        self.preview_pause_button = QPushButton("暂停", window)
        self.preview_pause_button.setObjectName("secondaryActionButton")
        self.preview_reset_button = QPushButton("重置", window)
        ...
        self.preview_settings_button = QPushButton("打开设置", window)
        self.preview_settings_button.setObjectName("primaryActionButton")
        self.preview_reminder_button = QPushButton("预览提醒弹窗", window)
        self.preview_reminder_button.setObjectName("secondaryActionButton")
        self.preview_settings_button.clicked.connect(self.open_settings)
        self.preview_reminder_button.clicked.connect(self.show_reminder_preview)

        layout.addWidget(self.preview_start_button)
        layout.addWidget(self.preview_pause_button)
        layout.addWidget(self.preview_reset_button)
        layout.addWidget(self.preview_settings_button)
        layout.addWidget(self.preview_reminder_button)
    ...
    def open_settings(self):
        dialog = SettingsDialog(interval_seconds=self.config.interval_seconds)
    ...
    def show_reminder_preview(self):
        ...
        self.reminder_dialog.finished.connect(self._handle_dialog_finished)
